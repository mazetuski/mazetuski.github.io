...
class BlogFixtures extends AbstractFixture implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog6 = new Blog();
        $blog6->setTitle('Blog de Prueba');
        $blog6->setBlog('Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque. Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque. Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque. Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque.');
        $blog6->setImage('gato.jpg');
        $blog6->setAuthor('Miguel Z.');
        $blog6->setTags('binary, one, zero, alive, dead, !trusting, movie, symblog');
        $blog6->setCreated(new \DateTime("2017-02-13 09:12:18"));
